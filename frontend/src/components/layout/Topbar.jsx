  ...
  return (
    <div className="topbar">
      <div className="topbar-left">
        <div className="page-title">{page.replace("-", " ")}</div>
      </div>
      ...
      <div className="topbar-right">
        <div className="search-bar">
          ...
          <input placeholder="Search courses, lectures..." />
        </div>
        ...
        <div className="relative">
          <button className="icon-btn" onClick={() => setNotifOpen(!notifOpen)}>
            ...
            {unreadCount > 0 && <div className="live-dot" style={{position:'absolute', top: 10, right: 12, width: 8, height: 8}} />}
          </button>
